...
namespace DiplomskiRad.Data.Migrations
{
    ...
    [Migration("20210910131111_addingPhoto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiplomskiRad.Entities.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppUserRole", b =>
                {
                    b.HasOne("DiplomskiRad.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("AppUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DiplomskiRad.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DiplomskiRad.Entities.Car", b =>
                {
                    b.HasOne("DiplomskiRad.Entities.Type", "Type")
                        .WithMany("Cars")
